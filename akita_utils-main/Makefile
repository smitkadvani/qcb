...
test: lint        ## Run tests and generate coverage report.
	$(ENV_PREFIX)pytest -v --cov-config .coveragerc --cov=akita_utils -l --tb=short --maxfail=1 tests/
...
release:          ## Create a new tag for release.
	...
	@echo "$${TAG}" > akita_utils/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add akita_utils/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "akita_utils = 'akita_utils.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run akita_utils'"
