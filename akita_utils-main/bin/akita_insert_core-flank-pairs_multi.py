...
"""
Derived from akita_scd_multi.py (https://github.com/calico/basenji/blob/master/bin/akita_scd_multi.py)

Compute insertion scores for variants in a TSV file, using multiple processes.
"""
